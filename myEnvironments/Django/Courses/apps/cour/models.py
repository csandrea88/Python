...
#         cname = postData['fcname']
#         desk = postData['fdesc']

#         if len(cname) < 1:
#             errors.append("Course: Course Name is required!")
                    
#         if len(cname) < 6:
#             errors.append("Course: Course Name must be at least 5 letters in length!")
    
#         if len(desc) < 1:
#             errors.append("Course: Course Name is required!")
                    
#         if len(desc) < 3:
#             errors.append("Course: Course Name must be at least 2 letters in length!")
